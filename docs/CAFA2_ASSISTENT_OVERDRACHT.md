...
7. Bereid de Cloudflare-inrichting voor volgens het activatiedocument. Doe al het overige werk ook wanneer secrets ontbreken. Noteer exact welke instellingen gebruiker nog zelf moet invullen. Vraag niet om API-sleutels in een chatbericht en schrijf ze niet in GitHub.
