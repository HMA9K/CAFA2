...
- Lokaal 157 Chromium-controles geslaagd, zonder JavaScript-runtimefouten. De volledige proeven omvatten actuele vraagroutes, eigen antwoorden, antwoordvensters, historische inzage, vertraagde antwoorden, journaalposten, voorraadtabellen, timers, desktop, mobiel, donker/licht en een korte toetsenbordviewport. Een fysieke telefoon met daadwerkelijk geopend toetsenbord is niet beproefd.
- Gepubliceerd met code [e72f2c3](https://github.com/HMA9K/CAFA2/commit/e72f2c3c701d794255699430eea1e0496bce5a01), Cloudflare-deployment `3442ae5e-ac21-4396-83e2-4acc9fb3dc19`, geslaagd. De live browser bevestigt de volledige puntenprompt in de chatbalk en invoerfocus na een klik. Live module is met SHA-256 gelijk aan lokaal; cacheversie `20260926-review2`, status `ready: true`. Buildlog: 181 publieke bestanden, vier Functions, broncontrole met 38 voltooide koppelingen en 115 bestanden, nul nieuwe, mislukte of wachtende koppelingen.
- De eerste assistentworkflow op `e72f2c3` slaagde in Chromium maar werd tijdens WebKit door een andere publicatie onderbroken. De herstart is daardoor geen volledig geslaagde eindcontrole. De volgende paginagroottepublicatie had een verouderde UI-hash voor `js/app.js`. Na controle van de wijziging in `setFont` is uitsluitend die UI-nulmeting met toelichting bijgewerkt in `e4301a1`. De officiële tentamendata en inhoudshashes blijven behouden.
- [Assistentcontrole op de gecombineerde code](https://github.com/HMA9K/CAFA2/actions/runs/36252491768) en [validatie](https://github.com/HMA9K/CAFA2/actions/runs/36252491733) geslaagd. Alle jobstappen bekeken: 108 Node-tests, twee presentatie-extractietests, bestaande regressies, build, vier Function-bundels, 157 Chromium- en 157 WebKit-controles, en bewijsupload. De nakijkconceptproeven slagen in beide browsers, zonder JavaScript-runtimefouten. Cloudflare-deployment `4983f596-a740-470b-bacc-af5b713bcea6` op `e4301a1` is geslaagd.
- Reacties in de nieuwe proeven zijn gesimuleerd; nul echte modelaanroepen. De puntenbeoordeling is niet inhoudelijk opnieuw getest. Geen nieuwe instelling, secret of bronbestand nodig. Nieuwe commits gebruiken het projectpseudoniem en het GitHub-noreplyadres.
...
- De startersknop **Bespreek mijn antwoord** heet nu **Kijk mijn antwoord na**. Na ontgrendelen en toestemming stuurt een klik direct een verzoek met het actuele eigen antwoord, de vraag en de uitwerking. Het verzoek vraagt wat klopt, welke fouten of stappen ontbreken en hoe die te verbeteren. Bij een leeg antwoord moet dit worden benoemd. Geen verplichte standwissel of inlevering; eigen antwoord en score blijven behouden.
- Nieuwe browserregressies controleren dat de knop zonder ontgrendeling niets verstuurt, de controle-instructie klaarzet, en na ontgrendeling precies één verzoek met het actuele MC-antwoord verstuurt. De bestaande controle op het ongewijzigde antwoord blijft behouden.
- Lokaal: 108 Node-tests, alle 13 bestaande regressiescripts, integratie-dry-run zonder wijzigingen, build en deploycontrole geslaagd. De build bevat 627 oefenvragen, 285 tentamenrecords inclusief drie demo's, 181 publieke bestanden en vier Functions. Een gerichte Chromium-proef controleert de nieuwe knop en behoud van het eigen antwoord. De eerste volledige lokale proef vond een overschreven variabele in de test zelf; die is hernoemd naar `review_before`.
- De eerste Actions-run vond een verouderde UI-nulmeting voor `js/exams.js` na de reeds gepubliceerde dashboardvolgorde `0703c94/1e927de`. Alleen deze UI-hash en de toelichtende commentaarregel zijn bijgewerkt. De inhoudshashes van de officiële tentamens blijven ongewijzigd.
- [Assistentcontrole](https://github.com/HMA9K/CAFA2/actions/runs/36250058147) en [bestaande validatie](https://github.com/HMA9K/CAFA2/actions/runs/36250058171) zijn geslaagd. Alle assistentjobstappen zijn bekeken: Node-tests, build, bestaande regressies, Function-bundeling, twee presentatie-extractietests, 155 Chromium- en 155 WebKit-browsercontroles en bewijsupload. Beide browsers controleren alle dertien oefenvraagtypen, elf tentamens, eigen antwoorden, journaalposten, voorraadtabellen, historische inzage, antwoordvensters, vertraagde antwoorden, desktop, mobiel, donkere modus en een korte toetsenbordviewport. Geen JavaScript-runtimefouten. Het toestemmings- en contextgedrag van de nieuwe nakijkknop is in beide browsers geslaagd.
- De echte oefenpagina toont de nieuwe knop in het rechterpaneel; donkere weergave visueel bekeken. De live module is met SHA-256 gelijk aan lokaal en de HTML gebruikt cacheversie `20260926-review1`. De statusroute geeft HTTP 200 met `ready: true`. De publicatielog bevestigt 181 publieke bestanden, vier Functions en de broncontrole: 38 voltooide koppelingen, 115 bestanden, `added: 0`, `failed: 0`, `pending: 0`.
- Reacties in deze nieuwe controles zijn gesimuleerd; nul echte modelaanroepen. De knop en contextoverdracht zijn getest, de inhoudelijke modelkwaliteit is niet opnieuw beproefd. Een fysieke telefoon met werkelijk geopend toetsenbord blijft een afzonderlijk open controlepunt. Er is geen nieuwe instelling, secret of bronbestand nodig voor deze knop.
