...
const tabs='<a data-tool-link="summary" href="#start">Samenvatting</a>'+tools.map(([id,label])=>'<a data-route="'+id+'" data-tool-link="'+id+'" href="#'+id+'">'+label+'</a>').join('');
const json=JSON.stringify(meta).replace(/</g,'\\u003c');
const html='<!doctype html><html lang="nl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="theme-color" content="#444159"><meta name="color-scheme" content="light"><title>CAFA2 · Interactieve samenvatting</title><link rel="stylesheet" href="css/summary.css?v=reader3"><link rel="stylesheet" href="css/summary-reader.css?v=reader3"><script id="reader-map" type="application/json">'+json+'</script><script defer src="js/summary-reader.js?v=reader3"></script><script data-goatcounter="https://cafa2.goatcounter.com/count" async src="https://gc.zgo.at/count.js"></script></head><body class="cafa-study reader-layout"><a class="reader-skip" href="#reader-main">Naar de inhoud</a><header class="reader-topbar"><a class="reader-brand" href="index.html#start">CAFA2 <span>Samenvatting</span></a><div class="reader-top-tools"><a href="index.html#start">Home</a><button type="button" data-font="-1" aria-label="Tekst kleiner">A−</button><button type="button" data-font="1" aria-label="Tekst groter">A+</button><button type="button" data-print class="reader-desktop-print">Afdrukken</button></div></header><nav class="reader-tabs" aria-label="Studiehulpmiddelen">'+tabs+'</nav><div class="reader-layout-grid"><aside class="reader-sidebar"><p class="side-head">Inhoud</p><nav aria-label="Hoofdstukken">'+nav+'</nav><p id="study-progress" class="reader-progress"></p><a class="reader-practice-link" href="index.html#oefenen">Naar oefenvragen →</a><a class="reader-practice-link" href="index.html#dashboard">Naar tentamens →</a></aside><div class="reader-mobilebar"><details id="reader-mobile-menu"><summary aria-label="Hoofdstukken openen">☰ <span>Inhoud</span></summary><nav aria-label="Mobiele hoofdstukken"><a class="reader-menu-overview" href="#start">Vakoverzicht</a>'+nav+'<button type="button" data-print class="study-button">Afdrukken</button></nav></details><span id="reader-current-title">Vakoverzicht</span><a id="reader-previous" href="#start" aria-label="Vorig hoofdstuk">‹</a><a id="reader-next" href="#kapitaalbelangen" aria-label="Volgend hoofdstuk">›</a></div><main id="reader-main" tabindex="-1"><noscript><p class="nojs-only">Alle hoofdstukken staan hieronder. Via Inhoud kun je direct naar een hoofdstuk; de paragrafen en voorbeelden zijn ook zonder scripts uitklapbaar.</p></noscript>'+overview+chapters.map(renderChapter).join('')+toolPages+'</main></div></body></html>';
