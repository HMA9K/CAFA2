...
home=home.replace('<p class="cafa-home-help">',wrap('home-quick','<nav class="study-home-links" aria-label="Naslag en voortgang"><a href="samenvatting.html#kernschema"><span>IC-kernschema</span><span aria-hidden="true">→</span></a><a href="#voortgang"><span>Voortgang</span><span aria-hidden="true">→</span></a><a href="samenvatting.html#begrippen"><span>Begrippen</span><span aria-hidden="true">→</span></a><a href="samenvatting.html#bronnen"><span>Bronnen</span><span aria-hidden="true">→</span></a><a href="samenvatting.html#wetsartikelen"><span>Wetsartikelen</span><span aria-hidden="true">→</span></a><a href="samenvatting.html#kapitaalboom"><span>Stroomdiagram Kapitaalbelangen</span><span aria-hidden="true">→</span></a></nav>')+'<p class="cafa-home-help">');
