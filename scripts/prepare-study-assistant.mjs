...
let html=original;
if(!html.includes('css/study-assistant.css')){const link='<link rel="stylesheet" href="css/study-assistant.css?v=20260926-float1">';html=html.includes('<!-- study-upgrade:styles -->')?html.replace('<!-- study-upgrade:styles -->',link+'<!-- study-upgrade:styles -->'):html.replace(/<\/head>/i,link+'\n</head>');}
if(!html.includes('src="js/study-assistant.mjs'))html=html.replace(/<\/body>/i,'<script type="module" src="js/study-assistant.mjs?v=20260926-float1"></script>\n</body>');
