...
try:
  with sync_playwright() as p:
    ...
    page.locator('.exam-case-resizer').press('End');page.wait_for_timeout(150)
    ...
    page.locator('.exam-case-resizer').press('Home');page.locator('.exam-case-resizer').press('ArrowRight');page.locator('.exam-case-resizer').press('ArrowRight');page.wait_for_timeout(100)
